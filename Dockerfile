...
ENV AUDIOBOOKSHELF_CUSTOM_PORT=3020
ENV AUDIOBOOKSHELF_REFRESH_INTERVAL=60000
...
HEALTHCHECK --interval=30s --timeout=10s --start-period=30s --retries=3 \
    CMD curl -f http://localhost:${AUDIOBOOKSHELF_CUSTOM_PORT:-3020}/api/health || exit 1
